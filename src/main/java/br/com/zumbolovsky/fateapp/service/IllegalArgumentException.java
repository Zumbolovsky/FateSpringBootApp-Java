...
import static br.com.zumbolovsky.fateapp.config.error.ErrorDebugMessages.ILLEGAL_ARGUMENT;
...
public class IllegalArgumentException extends APIException {
    ...
    public IllegalArgumentException(List<String> args,
                                    List<String> debugArgs) {
        super(args, debugArgs);
    }

    public IllegalArgumentException(List<String> debugArgs) {
