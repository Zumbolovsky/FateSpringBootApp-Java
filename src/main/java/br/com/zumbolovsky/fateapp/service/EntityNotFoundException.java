...
import static br.com.zumbolovsky.fateapp.config.error.ErrorDebugMessages.ENTITY_NOT_FOUND;
...
public class EntityNotFoundException extends APIException {
    ...
    public EntityNotFoundException(List<String> args,
                                    List<String> debugArgs) {
        super(args, debugArgs);
    }

    public EntityNotFoundException(List<String> debugArgs) {
