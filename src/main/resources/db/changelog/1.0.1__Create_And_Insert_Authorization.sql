...
BEGIN
  ...
  EXECUTE 'INSERT INTO PRIVILEGE (NAME) VALUES (''READ_PRIVILEGE''), (''WRITE_PRIVILEGE'')';
  EXECUTE 'INSERT INTO ROLE (NAME) VALUES (''ADMIN''), (''USER'')';
  EXECUTE 'INSERT INTO USER_INFO (EMAIL, PASSWORD, USER_NAME) VALUES (''admin@email.com'', MD5(''admin''), ''admin'')';
